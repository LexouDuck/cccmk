...
echo_TEST_HDRSFILE = find $(TESTDIR) -name "*.h" | sort | sed 's|\./||g' | sed 's|//|/|g' | grep -v '/standalone/'
...
echo_TEST_SRCSFILE = find $(TESTDIR) -name "*.c" | sort | sed 's|\./||g' | sed 's|//|/|g' | grep -v '/standalone/'
